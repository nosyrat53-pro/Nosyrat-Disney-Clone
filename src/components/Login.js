...
import x from '../images/cta-logo-two.png' ;
...
const LogoOne = styled.div`
    margin-bottom: 12px;
    width: ${props =>  props.width > 460 ? '350px' : "240px" } ;
`;
...
const Signup = styled.div`
    ...
    cursor: pointer;
    width: ${props =>  props.width > 460 ? '350px' : "240px" } ;
    // width: ${props => props.width < 375 ? '250px' : '200px'}   ;                
    padding: ${props =>  props.width > 460 ? '12.5px' : "9px" };
    margin-bottom: 12px;
